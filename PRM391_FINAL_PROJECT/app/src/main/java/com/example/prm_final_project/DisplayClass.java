...
import static com.example.prm_final_project.FreeDrawActivity.paint_brush;
import static com.example.prm_final_project.FreeDrawActivity.path;
...
public class DisplayClass extends View {
    public static ArrayList<Path> pathList = new ArrayList<>();
    public static ArrayList<Integer> colorList = new ArrayList<>();
    public ViewGroup.LayoutParams params;
    public static int current_brush = Color.BLACK;

    public DisplayClass(Context context) {
        super(context);
        init(context);
    }

    public DisplayClass(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public DisplayClass(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
